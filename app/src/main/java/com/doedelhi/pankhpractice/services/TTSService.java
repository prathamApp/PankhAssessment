...
public class TTSService implements TextToSpeech.OnInitListener {
    ...
    /**
     * Callbacks are registered for upon initialization. Set an activity on the TTSService
     * object to have this class take care of shutting down the TextToSpeech object or register
     * for {@link Application.ActivityLifecycleCallbacks} in your application and
     */
    ...
    public TTSService(final Application application) {
        ...
        this.callbacks = new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityDestroyed(Activity activity) {
                if (TTSService.this.activity == activity) {
                    shutdown();
                }
            }
        };
