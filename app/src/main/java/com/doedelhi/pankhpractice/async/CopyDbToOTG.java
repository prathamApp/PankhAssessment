...
import static com.doedelhi.pankhpractice.database.AppDatabase.DB_NAME;
...
public class CopyDbToOTG extends AsyncTask {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            String thisdeviceFolderName = "DeviceId_" + BaseActivity.appDatabase.getStatusDao().getValue("DeviceId");
