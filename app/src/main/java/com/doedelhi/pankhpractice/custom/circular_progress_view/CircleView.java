...
public class CircleView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // Defaults, may need to link this into theme setting

        int arcColor = getColor(context, R.color.white);
        int arcBorderColor = getColor(context, R.color.white);
        int progressColor = getColor(context, R.color.white);
        textColor = getColor(context, R.color.black);
        int indicatorColor = getColor(context, R.color.green);
