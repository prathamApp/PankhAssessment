package com.doedelhi.pankhpractice.custom.swipeButton;
...
import static com.doedelhi.pankhpractice.custom.swipeButton.UiUtils.animateFadeHide;
import static com.doedelhi.pankhpractice.custom.swipeButton.UiUtils.animateFadeShow;
import static com.doedelhi.pankhpractice.custom.swipeButton.UiUtils.dpToPx;
...
public class ProSwipeButton extends RelativeLayout {
    ...
    private float swipeDistance = Constants.DEFAULT_SWIPE_DISTANCE;
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            btnRadius = a.getFloat(R.styleable.ProSwipeButton_btn_radius, Constants.BTN_INIT_RADIUS);
            textSize = a.getDimensionPixelSize(R.styleable.ProSwipeButton_text_size, (int) Constants.DEFAULT_TEXT_SIZE);
        } finally {
            a.recycle();
        }
    }
    ...
    public void morphToCircle() {
        ...
        ObjectAnimator cornerAnimation =
                ObjectAnimator.ofFloat(gradientDrawable, "cornerRadius", Constants.BTN_INIT_RADIUS, Constants.BTN_MORPHED_RADIUS);
        ...
        animatorSet.setDuration(Constants.MORPH_ANIM_DURATION);
    ...
    private void morphToRect() {
        setupTouchListener();
        ObjectAnimator cornerAnimation =
                ObjectAnimator.ofFloat(gradientDrawable, "cornerRadius", Constants.BTN_MORPHED_RADIUS, Constants.BTN_INIT_RADIUS);
