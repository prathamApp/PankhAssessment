...
public class ProgressLayout extends View {
    ...
    public ProgressLayout(Context context, AttributeSet attrs,
        ...
        try {
            mMax = a.getInt(R.styleable.ProgressLayout_c_max, DEFAULT_MAX);
            mProgress = a.getInt(R.styleable.ProgressLayout_c_progress,
                    DEFAULT_PROGRESS);
            mRadius = (int) a.getDimension(
                    R.styleable.ProgressLayout_c_progressRadius, DEFAULT_RADIUS);
            mProgressColor = a.getColor(
                    R.styleable.ProgressLayout_c_progressColor,
                    DEFAULT_PROGRESS_COLOR);
            mProgressDescColor = a.getColor(
                    R.styleable.ProgressLayout_c_progressDescColor,
                    DEFAULT_PROGRESS_DESC_COLOR);
            mBorderWidth = (int) a.getDimension(
                    R.styleable.ProgressLayout_c_borderWidth,
                    DEFAULT_BORDER_WIDTH);
            mProgressDesc = a
                    .getString(R.styleable.ProgressLayout_c_progressDesc);
            mIsShowDesc = a.getBoolean(R.styleable.ProgressLayout_c_isShowDesc, DEFAULT_ISSHOWDESC);
