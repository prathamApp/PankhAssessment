package com.doedelhi.pankhpractice.custom.toggle_button
...
open class SwipeableButton @JvmOverloads constructor(
    ...
    public var onSwipedListener: (() -> Unit)? = null
    public var onSwipedOnListener: (() -> Unit)? = null
    public var onSwipedOffListener: (() -> Unit)? = null
