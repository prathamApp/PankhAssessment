package com.doedelhi.pankhpractice.custom.gif_viewer;
...
public class GifViewZoom extends View {
    ...
    public GifViewZoom(Context context) {
        this(context, null);
    }

    public GifViewZoom(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.CustomTheme_gifViewStyle);
    }

    public GifViewZoom(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (movie != null) {
            ...
            int movieWidth = display.getWidth();
            int movieHeight = (int) (display.getHeight()/1.5);
    ...
    protected void onDraw(Canvas canvas) {
        if (movie != null) {
            if (!mPaused) {
                ...
                Log.d("hhh",((float) this.getHeight() )+"  "+ (float) movie.height());

                canvas.scale((float) this.getWidth() / (float) movie.width(),
