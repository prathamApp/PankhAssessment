package com.doedelhi.pankhpractice.custom.mary_pop_up;
...
//                }
                    ...
                    /*if(popupView instanceof DraggableView) {
                        ...
                        if (scaleDownCloseOnDrag) {
                            draggableView.setViewAnimator(new ReturnOriginViewAnimator() {
                                @Override
                                public boolean animateExit(@NonNull DraggableView draggableView, Path.Direction direction, int duration) {
                                    close(true);
                                    return true;
                                }
                            });
    ...
    static class DraggableViewListener /*extends DraggableView.DraggableViewListenerAdapter*/ {
      ...
      /*  @Override
       ...
       /* @Override
        public void onDraggedStarted(DraggableView draggableView, Path.Direction direction) {
            MaryPopup popup = reference.get();
            if (popup != null) {
                popup.close(false);
            }
