...
import com.doedelhi.pankhpractice.ui.bottom_fragment.StudentClickListener;
...
public class EnrollmentAdapter extends RecyclerView.Adapter<EnrollmentAdapter.MyViewHolder> {
    ...
    public EnrollmentAdapter(Context c, Fragment context, List<Student> studentAvatars, ArrayList avatarList) {
