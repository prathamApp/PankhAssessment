package com.doedelhi.pankhpractice.ui.choose_assessment.science;
...
import com.doedelhi.pankhpractice.custom.NonSwipeableViewPager;
import com.doedelhi.pankhpractice.custom.circular_progress_view.AnimationStyle;
import com.doedelhi.pankhpractice.custom.circular_progress_view.CircleView;
import com.doedelhi.pankhpractice.custom.circular_progress_view.CircleViewAnimation;
import com.doedelhi.pankhpractice.custom.dots_indicator.WormDotsIndicator;
import com.doedelhi.pankhpractice.custom.swipeButton.ProSwipeButton;
import com.doedelhi.pankhpractice.database.AppDatabase;
import com.doedelhi.pankhpractice.database.BackupDatabase;
import com.doedelhi.pankhpractice.discrete_view.DiscreteScrollView;
...
import com.doedelhi.pankhpractice.ui.choose_assessment.science.viewpager_fragments.ViewpagerAdapter;
...
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.ARRANGE_SEQUENCE;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.AUDIO;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.DOWNLOAD_MEDIA_TYPE_ANSWER_AUDIO;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.DOWNLOAD_MEDIA_TYPE_ANSWER_IMAGE;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.DOWNLOAD_MEDIA_TYPE_ANSWER_VIDEO;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.DOWNLOAD_MEDIA_TYPE_VIDEO_MONITORING;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.EXAMID;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.FILL_IN_THE_BLANK;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.FILL_IN_THE_BLANK_WITH_OPTION;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.IMAGE_ANSWER;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.KEYWORDS_QUESTION;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.LANGUAGE;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.MATCHING_PAIR;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.MULTIPLE_CHOICE;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.MULTIPLE_SELECT;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.PARAGRAPH_BASED_QUESTION;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.SCORE_COUNT;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.TEXT_PARAGRAPH;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.TRUE_FALSE;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.VIDEO;
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.VIDEOMONITORING;
import static com.doedelhi.pankhpractice.utilities.Assessment_Utility.getFileName;
...
//                showQuestions();
                ...
                finish();
                Toast.makeText(this, R.string.connect_to_internet_to_download_paper_format, Toast.LENGTH_SHORT).show();
            }
        }
...
//                        }
                    ...
                    public void onError(ANError anError) {
                        String examName;
                        examName = AppDatabase.getDatabaseInstance
                                (ScienceAssessmentActivity.this).getTestDao().getExamNameById(selectedExamId);
                        if (examName != null && !examName.equalsIgnoreCase(""))
                            downloadFailedExamList.add(examName);
                        else {
                            examName = AppDatabase.getDatabaseInstance
                                    (ScienceAssessmentActivity.this).getNiosExamDao().getExamById(selectedExamId);
                            if (examName != null && !examName.equalsIgnoreCase(""))
                                downloadFailedExamList.add(examName);
                        }
...
//        outerModalClass.setStudentId(Assessment_Constants.currentStudentID);
        ...
        if (resultList.size() > 0) {
          ...
          /*  Intent intent = new Intent(this, ResultActivity_.class);
            ...
            finish();*/
            String score = totalMarks + "/" + outOfMarks;
            Intent intent = new Intent();
            ...
            try {
                ...
                Log.d("$$$", "createDataBaseAfter");
                          ...
                          /*  Room.databaseBuilder(this,
                            ...
                            .build();*/
                if (new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/PankhBackups" + "/pankh_assessment_database").exists()) {
                    try {
                        copyDataBase();
            ...
            new AsyncTask<Void, Integer, Void>() {
                ...
                protected Void doInBackground(Void... voids) {
                    ...
                    try {
                        ...
                        SQLiteDatabase db = SQLiteDatabase.openDatabase(Environment.getExternalStorageDirectory().getAbsolutePath() + "/PankhBackups" + "/pankh_assessment_database", null, SQLiteDatabase.OPEN_READONLY);
                        if (db != null) {
                            try {
