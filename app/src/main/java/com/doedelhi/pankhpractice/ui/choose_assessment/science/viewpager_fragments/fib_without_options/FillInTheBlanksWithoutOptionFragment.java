package com.doedelhi.pankhpractice.ui.choose_assessment.science.viewpager_fragments.fib_without_options;
...
import com.doedelhi.pankhpractice.custom.gif_viewer.GifView;
import com.doedelhi.pankhpractice.database.AppDatabase;
import com.doedelhi.pankhpractice.domain.ScienceQuestion;
import com.doedelhi.pankhpractice.services.stt_service.ContinuousSpeechService;
import com.doedelhi.pankhpractice.services.stt_service.STT_Result;
import com.doedelhi.pankhpractice.ui.choose_assessment.science.viewpager_fragments.fib_without_options.FillInTheBlanksWithoutOptionFragment_;
...
import static com.doedelhi.pankhpractice.utilities.Assessment_Constants.STT_REGEX_3;
...
public class FillInTheBlanksWithoutOptionFragment extends Fragment
    ...
    public void reInitCurrentItems() {
        etAnswer = Objects.requireNonNull(ScienceAssessmentActivity.viewpagerAdapter.getCurrentFragment().getView()).findViewById(R.id.et_answer);
        ib_mic = ScienceAssessmentActivity.viewpagerAdapter.getCurrentFragment().getView().findViewById(R.id.ib_mic);
        micPressed(0);
    }
    ...
    public void setFillInTheBlanksQuestion() {
        ...
        question.setText(Html.fromHtml(scienceQuestion.getQname().replace("\n","<br>")));
