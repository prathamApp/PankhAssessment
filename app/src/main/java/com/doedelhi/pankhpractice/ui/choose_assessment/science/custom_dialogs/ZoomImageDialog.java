...
import com.doedelhi.pankhpractice.custom.gif_viewer.GifViewZoom;
import com.doedelhi.pankhpractice.custom.zoom_image.ZoomageView;
...
//        SimpleDraweeView thumbnail = (SimpleDraweeView) findViewById(R.id.thumbnail);
...
//                            .apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.NONE))
                ...
                if (imgPath[len].equalsIgnoreCase("mp3")) {
                    rl_para.setVisibility(View.GONE);
                    zoomImg.setVisibility(View.GONE);
//                    thumbnail.setVisibility(View.GONE);
                    gifView.setVisibility(View.GONE);
