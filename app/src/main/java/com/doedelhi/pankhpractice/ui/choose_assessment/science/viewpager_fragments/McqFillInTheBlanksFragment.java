...
import com.doedelhi.pankhpractice.ui.choose_assessment.science.viewpager_fragments.McqFillInTheBlanksFragment_;
    ...
    private void setMcqsQuestion() {
        ...
        if (!scienceQuestion.getPhotourl().trim().equalsIgnoreCase("")) {
            ...
            if (questionExtension.equalsIgnoreCase("gif")
                    || questionExtension.equalsIgnoreCase("png")
                    || questionExtension.equalsIgnoreCase("jpg")
...
//                    zoomImg.setVisibility(View.VISIBLE);
          ...
          /*  questionGif.setOnClickListener(new View.OnClickListener() {
           ...
           /* } else {
            ...
            } else if (questionExtension.equalsIgnoreCase("mp3")) {
                questionImage.setVisibility(View.VISIBLE);
        ...
        if (options != null) {
            ...
            for (int r = 0; r < options.size(); r++) {
                ...
                if (!options.get(r).getChoicename().trim().equalsIgnoreCase("")) {
                    textCnt++;
                }
