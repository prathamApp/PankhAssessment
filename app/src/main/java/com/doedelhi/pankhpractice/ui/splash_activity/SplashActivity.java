...
import com.doedelhi.pankhpractice.custom.customFont.SansTextView;
...
import com.doedelhi.pankhpractice.interfaces.Interface_copying;
import com.doedelhi.pankhpractice.interfaces.PermissionResult;
import com.doedelhi.pankhpractice.services.AppExitService;
import com.doedelhi.pankhpractice.ui.bottom_fragment.BottomStudentsFragment_;
...
import com.doedelhi.pankhpractice.utilities.PermissionUtils;
import com.doedelhi.pankhpractice.utilities.SplashSupportActivity;
...
public class SplashActivity extends SplashSupportActivity implements SplashContract.SplashView, PermissionResult, Interface_copying {
    ...
    @ViewById(R.id.tv_learn_at_your_pace)
    SansTextView tv_learn_at_your_pace;
    ...
    public void init() {
        ...
        final Typeface title_font = Typeface.createFromAsset(getAssets(), "fonts/Quicksand-Bold.ttf");
        tv_typer.setTypeface(title_font);
        tv_typer.setVisibility(View.VISIBLE);
        tv_typer.setTextColor(BLACK);
        tv_typer.animateText("PANKH\nPRACTICE");
        tv_learn_at_your_pace.setText(Html.fromHtml("Learn and Practice at <b><i>your pace</i></b><br>towards <b><i>your goal.</i></b>"));
//        tv_typer.setAnimationListener(hTextView -> /*after animation complete*/);
