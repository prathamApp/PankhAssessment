package com.doedelhi.pankhpractice.ui.choose_assessment.science.viewpager_fragments;
...
import com.doedelhi.pankhpractice.ui.choose_assessment.science.viewpager_fragments.FillInTheBlanksWithoutOptionFragment_;
   ...
   /* @Override
    ...
    private void reInitCurrentItems() {
        if (ScienceAssessmentActivity.viewpagerAdapter != null) {
            ...
            ib_mic = Objects.requireNonNull(ScienceAssessmentActivity.viewpagerAdapter.getCurrentFragment().getView()).findViewById(R.id.ib_mic);
        }
