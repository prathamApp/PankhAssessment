    ...
    static void deleteTables() {
        new AsyncTask<Void, Integer, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    SQLiteDatabase db = SQLiteDatabase.openDatabase(Environment.getExternalStorageDirectory().getAbsolutePath() + "/PankhBackups" + "/pankh_assessment_database", null, SQLiteDatabase.OPEN_READWRITE);
                    if (db != null) {
